...
> To learn more about forking the Mainnet on Hardhat, and gaining access to all the smart contracts on it, visit [https://hardhat.org/guides/mainnet-forking.html](https://hardhat.org/guides/mainnet-forking.html).
